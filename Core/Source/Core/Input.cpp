...
namespace Realgar
{
    ...
    int KeyDown(lua_State* L)
    {
        ...
        {
            lua_pushnil(L);
            lua_pushstring(L, "key not given");
            lua_error(L);
        }
    ...
    int MouseButtonDown(lua_State* L)
    {
        ...
        {
            lua_pushnil(L);
            lua_pushstring(L, "button not given");
            lua_error(L);
        }
    ...
    void registerInput(lua_State* L) {
        ...
        lua_pushcfunction(L, KeyReleased);
        lua_settable(L, -3);
        ...
        lua_pushcfunction(L, MouseButtonPressed);
        lua_settable(L, -3);

        lua_pushstring(L, "mouseButtonReleased");
        lua_pushcfunction(L, MouseButtonReleased);
        lua_settable(L, -3);

        lua_pop(L, 1);
    }

    void Input::registerInput(lua_State* L)
    {
        if (window == nullptr)
            std::cout << "Set window for input!\n";
        else
            Realgar::registerInput(L);
    }
}
